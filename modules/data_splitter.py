...
from .data_set_generic import Dataset as data_set_class
...
class DatasetDivider(object):
    ...
    """
    def __init__(
            self, data_set_obj=None, test_size=0.5, validation_size=0.1,
    ...
    def get_train_test_val_set_objs(self):
        ...
        train_data_set, validation_data_set = self._split_data_in_sets(
            train_data_set, self.validation_size/(1-self.test_size),
