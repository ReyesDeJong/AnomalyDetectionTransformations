...
#TODO MODIFY HERE
def create_auc_table(metric='acc_at_percentil'):#'roc_auc'):#'acc_at_percentil'):#
  #TODO MODIFY HERE
  RESULTS_DIR = os.path.join(
      PROJECT_PATH,
      # 'results/PAPER_RESULTS/HITS_NAIVE_TRANSFORMS_D/resnet_VAL_epochs/Transformer_OD_Model/all_metric_files/'
      'results/PAPER_RESULTS/ZTF_NAIVE_TRANSFORMS_E/resnet_VAL_epochs/Transformer_OD_Model/all_metric_files'
  )
