...
from modules.data_loaders.base_line_loaders import save_roc_pr_curve_data, \
  get_class_name_from_index, get_channels_axis, load_ztf_real_bog, load_hits1c, load_hits4c
...
#TODO MODIFY HERE
def create_auc_table(metric='acc_at_percentil_97_73'):#'roc_auc'):#'acc_at_percentil_97_73'):#'roc_auc'):#'acc_at_percentil'):#
  #TODO MODIFY HERE
  RESULTS_DIR = os.path.join(
      PROJECT_PATH,
      'results/PAPER_RESULTS/HITS_NAIVE_TRANSFORMS_D_to_have_percentile_97_73/resnet_VAL_epochs/Transformer_OD_Model/all_metric_files/'
      # 'results/PAPER_RESULTS/ZTF_NAIVE_TRANSFORMS_E_to_have_percentile_97_73/resnet_VAL_epochs/Transformer_OD_Model/all_metric_files'
  )
