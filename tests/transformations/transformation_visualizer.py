...
if __name__ == "__main__":
  ...
  for i in range(transformer.n_transforms):
    ...
    inliers_title = 'Inlier trf:%s, min4_mean: %.2f, max4_mean: %.2f' % (
    ...
    outliers_title = 'outlier trf:%s, min4_mean: %.2f, max4_mean: %.2f' % (
