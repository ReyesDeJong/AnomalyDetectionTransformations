...
from scripts.transformation_selection.histogram_experiments.dict_generator_clf_wrn_rdm_fid import ResultDictGeneratorClfRdmWRNFID


class ResultDictGeneratorClfRdmDHFID(ResultDictGeneratorClfRdmWRNFID):

  def __init__(self, data_loader: HiTSOutlierLoader):
    super().__init__(data_loader)
    self._generator_name = 'ClfRdmDHFID'
...
if __name__ == "__main__":
  ...
  for data_loader_i in data_loaders:
    ...
    print(x_train.shape)
    csv_gen = ResultDictGeneratorClfRdmDHFID(data_loader_i)
