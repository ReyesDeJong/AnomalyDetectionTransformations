...
from modules.geometric_transform.transformer_no_compositions_no_kernel import NoCompositionNoKernelTransformer
...
def main():
  ...
  aux_transformer = NoCompositionNoKernelTransformer()
  trf_72 = Transformer()
  ...
  for loader_i in data_loaders:
    ...
    pickle_name = 'simple_rank_%s.pkl' % loader_i.name
    result_all_runs = {}
    for run_i in range(N_RUNS):
      ...
      for power_set_idx in indexes_for_power_set:
        if power_set_idx == -1:
          ...
          trfer = NoCompositionNoKernelTransformer()
