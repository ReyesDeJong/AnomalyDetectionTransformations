...
TRAIN_TIME = 10
EXP_NAME = 'HITS_ZTF_FULL_G_L_TRANSFORMS'
...
def best_score_evaluation(result_folder_name, epochs, patience=0):
  ...
  all_gauss_transformer = transformations_tf.KernelTransformer(
      rotations=True, flips=True, gauss=True, log=False ,name='All_Gauss_Transform')
  all_laplace_transformer = transformations_tf.KernelTransformer(
      rotations=True, flips=True, gauss=True, log=False,
      name='All_Laplace_Transform')
  ...
  all_gauss_transformer, all_laplace_transformer,
