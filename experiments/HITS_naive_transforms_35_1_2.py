...
TRAIN_TIME = 10
EXP_NAME = 'HITS_NAIVE_TRANSFORMS_35_1_2'
...
def best_score_evaluation(result_folder_name, epochs, patience=0):
  ...
  manual_select_transformer = transformations_tf.KernelTransformer(name='Manual_35_Transform')
  manual_list = [(0, 0, 0, 0, 0, 0), (0, 0, -8, 0, 0, 0),
  ...
  manual_select_transformer.set_transformations_to_perform(manual_list)

  manual_select_2_transformer = transformations_tf.KernelTransformer(
    name='Manual_35_2_Transform')
  transf_list = manual_select_2_transformer.tranformation_to_perform
  transf_list.remove((0, 0, 0, 0, 1, 0))
  manual_select_2_transformer.set_transformations_to_perform(transf_list)
  ...
  # transformer_72,
  manual_select_2_transformer,
  manual_select_transformer,
  )
